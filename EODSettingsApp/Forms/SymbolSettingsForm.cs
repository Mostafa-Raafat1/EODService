...
namespace EODSettingsApp.Forms
{
    ...
    public partial class SymbolSettingsForm : Form
    {
        ...
        private void SetupGridColumns()
        {
            ...
            dgvStocks.Columns.Add(new DataGridViewTextBoxColumn { Name = "Id", HeaderText = "ID", DataPropertyName = "Id", FillWeight = 22 });
            dgvStocks.Columns.Add(new DataGridViewTextBoxColumn { Name = "SC_Comp_Id", HeaderText = "Comp ID", DataPropertyName = "SC_Comp_Id", FillWeight = 30 });
            dgvStocks.Columns.Add(new DataGridViewTextBoxColumn { Name = "StockName", HeaderText = "Stock Name", DataPropertyName = "StockName", FillWeight = 120 });
            dgvStocks.Columns.Add(new DataGridViewTextBoxColumn { Name = "Isin", HeaderText = "ISIN", DataPropertyName = "Isin", FillWeight = 50 });
            dgvStocks.Columns.Add(new DataGridViewTextBoxColumn { Name = "YahooFinanceID", HeaderText = "Yahoo Ticker", DataPropertyName = "YahooFinanceID", FillWeight = 55 });
            dgvStocks.Columns.Add(new DataGridViewCheckBoxColumn { Name = "YahooFinanceExists", HeaderText = "YF", DataPropertyName = "YahooFinanceExists", FillWeight = 25 });
            dgvStocks.Columns.Add(new DataGridViewTextBoxColumn { Name = "TwelveDataID", HeaderText = "TD Ticker", DataPropertyName = "TwelveDataID", FillWeight = 55 });
            dgvStocks.Columns.Add(new DataGridViewCheckBoxColumn { Name = "TwelveDataExists", HeaderText = "TD", DataPropertyName = "TwelveDataExists", FillWeight = 25 });
            dgvStocks.Columns.Add(new DataGridViewTextBoxColumn { Name = "ReuterID", HeaderText = "Reuters Ticker", DataPropertyName = "ReuterID", FillWeight = 55 });
            dgvStocks.Columns.Add(new DataGridViewCheckBoxColumn { Name = "ReuterExists", HeaderText = "LSEG", DataPropertyName = "ReuterExists", FillWeight = 25 });
            dgvStocks.Columns.Add(new DataGridViewTextBoxColumn { Name = "StockExchange", HeaderText = "Exchange", DataPropertyName = "StockExchange", FillWeight = 45 });
        }
        ...
        private void DgvStocks_SelectionChanged(object? sender, EventArgs e)
        {
            ...
            if (stock != null)
            {
                ...
                txtReuterId.Text = stock.ReuterID ?? "";
                chkReuterActive.Checked = stock.ReuterExists;
        ...
        private void ChkReuterActive_CheckedChanged(object? sender, EventArgs e)
        {
            txtReuterId.Enabled = chkReuterActive.Checked;
            txtReuterId.BackColor = chkReuterActive.Checked ? Color.White : Color.FromArgb(241, 245, 249);
        }
        ...
        private void BtnUpdateStock_Click(object? sender, EventArgs e)
        {
            ...
            if (!chkYahooActive.Checked && !chkTwelveDataActive.Checked && !chkReuterActive.Checked)
            {
                SetStatus(success: false, "✘ At least one provider (Yahoo, Twelve Data, or Reuters) must be enabled.");
                return;
            }
            ...
            if (chkReuterActive.Checked && string.IsNullOrWhiteSpace(reuterId))
            {
                SetStatus(success: false, "✘ Reuters / LSEG Ticker is required when LSEG Active is enabled.");
                return;
            }
            ...
            stock.ReuterID = string.IsNullOrWhiteSpace(reuterId) ? null : reuterId;
            stock.ReuterExists = chkReuterActive.Checked;
            ...
            try
            {
                ...
                foreach (var s in _stocks)
                {
                    ...
                    if (existing != null)
                    {
                        ...
                        existing.ReuterID = s.ReuterID;
                        existing.ReuterExists = s.ReuterExists;
